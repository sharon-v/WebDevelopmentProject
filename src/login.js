...
//     messageElement.classList.remove("loginForm__message--success",
//     "loginForm__message--error");
...
// ".loginForm__input-error-message").textContent = message;
// }
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.querySelectorAll('.loginForm__input').forEach((inputElement) => {
    inputElement.addEventListener('blur', (e) => {
      if (e.target.id === 'login__email' && e.target.value.length > 0 &&
